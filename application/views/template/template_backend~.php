...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <?php if($this->fungsi->user_login()->user_level == 1) { ?>
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Data Master Jemaat :</h6>
                        <a class="collapse-item" href="<?=base_url()?>unsur">Unsur</a>
                        <a class="collapse-item" href="<?=base_url()?>wijk">Wijk</a>
                        <a class="collapse-item" href="<?=base_url()?>ksp">KSP</a>
                    </div>
                </div>
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?=base_url()?>jenisbarang">Jenis Barang</a>
                        <a class="collapse-item" href="<?=base_url()?>bahan">Bahan</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <?php } ?>
            <?php if($this->fungsi->user_login()->user_level == 2) { ?>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url()?>jemaat">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Data Jemaat</span></a>
            ...
            <?php if($this->fungsi->user_login()->user_level == 3) { ?>
            <li class="nav-item">
                <a class="nav-link" href="<?=base_url()?>inventaris">
                    <i class="fas fa-fw fa-archive"></i>
                    <span>Data Barang</span></a>
            ...
            <!-- <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?=base_url()?>user">Konfigurasi Beranda</a>
                    </div>
                </div>
            </li> -->
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Gereja GKI Harapan Abepura 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
